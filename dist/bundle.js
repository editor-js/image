...
var Ui = function () {
  ...
  _createClass(Ui, [{
    ...
    key: 'beforeSend',
    value: function beforeSend(fileUploaded) {
      var _this3 = this;
      ...
      reader.onload = function (e) {
        _this3.showPreloader(e.target.result);
      };
    }
    ...
    value: function fillImage(url) {
      ...
      this.nodes.imageEl.addEventListener('load', function () {
        _this4.toggleStatus(Ui.status.FILLED);

        // preloader does not exists on first rendering with presaved data
        if (_this4.nodes.imagePreloader) {
          _this4.nodes.imagePreloader.style.backgroundImage = '';
        }
      });
    }
...
var _coverter = __webpack_require__(14);

var _coverter2 = _interopRequireDefault(_coverter);
  ...
  _createClass(ImageTool, [{
    ...
    get: function get() {
      return {
         ...
         */
        tags: ['img'],
        handler: _coverter2.default.fromHtml,
        ...
        fileHandler: _coverter2.default.fromDroppedFile,
        ...
        patternHandler: _coverter2.default.fromPastedUrl
      };
    }
  }]);
...
var Converter = function () {
  ...
  _createClass(Converter, null, [{
     ...
     */
    value: function fromDroppedFile(file) {
      var reader = new FileReader();
    ...
    key: 'fromPastedUrl',
    value: function fromPastedUrl(pastedUrl) {
      return {
        file: {
          url: pastedUrl
        }
